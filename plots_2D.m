...
refline(1,0)
title('2D : Cyclic vs Acyclic Graph Comparision over all possible rulesets')

%% STDEV CHECK
errorbar(mean(acyclic_event_matrix,2), mean(cyclic_event_matrix,2),std(acyclic_event_matrix'),'.k')
